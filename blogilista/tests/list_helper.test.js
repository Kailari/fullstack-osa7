...
describe('total likes', () => {
  ...
  test('of a bigger list is calculated right', () => {
    expect(listHelper.totalLikes(listWithMultipleBlogs))
      .toBe(36)
  })
})
...
describe('favorite blog', () => {
  ...
  test('of list with multiple blogs to equal the blog with greatest number of likes', () => {
  ...
  test('of list with multiple blogs with equal likes to have correct (greatest) number of likes', () => {
